module github.com/axiom-crypto/verkle-vs-patricia

go 1.19

require (
	github.com/axiom-crypto/verkle-vs-patricia/histogram v0.0.0
...
replace github.com/axiom-crypto/verkle-vs-patricia/histogram => ./cmd/analytics/histogram
